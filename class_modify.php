...
<?php
  ...
  <html>
    ...
    <body>
      ...
      <div id="register">
        <form action="./class_modify_action.php" method="post" enctype="multipart/form-data">
          ...
          <table id="register" align=center>
            ...
            <tbody>
              ...
              <tr>
                ...
                <td class="teacher"><input type="text" name="teacher" id="teacher" value="<?=$teacher?>"></td>
              </tr>

              <tr>
                <th scope="row"><label for="date">일자</label></th>
                <td class="date"><input type="text" name="date" id="date" value="<?=$date?>"></td>
              </tr>

              <tr>
                <th scope="row"><label for="time">시간</label></th>
                <td class="time"><input type="text" name="time" id="time" value="<?=$time?>"></td>
              </tr>

              <tr>
                <th scope="row"><label for="place">장소</label></th>
                <td class="place"><input type="text" name="place" id="place" value="<?=$place?>"></td>
              </tr>

              <tr>
                <th scope="row"><label for="peoples">인원</label></th>
                <td class="peoples">0 - <input type="text" name="peoples" id="peoples" value="<?=$peoples?>"> 명</td>
              </tr>

              <tr>
                <th scope="row"><label for="charge">비용</label></th>
                <td class="charge"><input type="text" name="charge" id="charge" value="<?=$charge?>"> 원</td>
              </tr>
              ...
              <tr>
                ...
                <td class="image"><input type="hidden" name="image" id="image">
