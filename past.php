                  ...
                  <?php
                    ...
                    while ($row = $result->fetch_assoc()) {
                      ...
                      <tr>
                        ...
                        <td><a href = "detail.php?no=<?php echo $row['class_num']?>">
                          <?php echo $row['title']?>
                        </td>
                        ...
                        <td><input type="hidden" name="no" value="<?php echo $row['no']?>">
                          ...
                          <input type="button" name="delete_btn" value="재등록"
                          onclick="location.href='./re_register.php?no=<?php echo $row['no']?>'"></td>
